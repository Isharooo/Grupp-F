...
const ProductsPage = () => {
    ...
    // Lås scroll vid öppnad sidomeny
    useEffect(() => {
            ...
            <div className="max-w-6xl mx-auto w-full px-4 py-6">
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex justify-center gap-4 my-4">
                        {currentPage > 0 && (
                            <button className="text-blue-600 font-medium py-2" onClick={loadPreviousPage}>
                                Previous Page
                            </button>
                        )}

                        {(currentPage + 1) * PAGE_SIZE < totalProducts && (
                            <button className="text-blue-600 font-medium py-2" onClick={loadNextPage}>
                                Next Page
                            </button>
                        )}
                    </div>
